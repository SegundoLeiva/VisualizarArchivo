...
public class BaseOnPremExample extends BasePublicAPIExample {
	...
	public Session getCmisSession() {
		if (cmisSession == null) {
			...
			parameter.put(SessionParameter.USER, bundle.getString("username"));
		...
		if (this.requestFactory == null) {
    		...
    		this.requestFactory = HTTP_TRANSPORT.createRequestFactory(new HttpRequestInitializer() {
    			...
    			public void initialize(HttpRequest request) throws IOException {
    				...
    				request.getHeaders().setBasicAuthentication(bundle.getString("username"), bundle.getString("password"));
    			}
    		});
		}
	...
	public String getAlfrescoAPIUrl() {
		...
		final ResourceBundle bundle = ResourceBundle.getBundle("config");
		String host = bundle.getString("host")+"/alfresco"; 
		return host + "/api/";
	}
